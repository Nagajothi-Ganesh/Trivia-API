...
def paginate_questions(request, selection):
    ...
    quests = [question.format() for question in selection]
    questions = quests[start:end]
...
def create_app(test_config=None):
    ...
    def search_questions():
        ...
        try:
            selection = Question.query.filter(Question.question.ilike("%{}%".format(searchTerm))).order_by(Question.id).all()
            questions = paginate_questions(request, selection)
